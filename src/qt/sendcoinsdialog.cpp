    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a Pakcoin address (e.g. PS2s6xGvu731ipSKTM3THGdNZCwgirxqK6)"));
#endif
...
bool SendCoinsDialog::quickSend()
{
    ...
    case WalletModel::OK:
        ...
        QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm send coins"),
											                          tr("%1 pakcoins had been sent,the remaining %2 pakcoins continue ?").arg((double)sendstatus.fee/COIN).arg((double)reAmount/COIN),
