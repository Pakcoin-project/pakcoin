...
{
    if(Height > pindexBest->nHeight) { return "0x000007d69ba0f79b4823effb06b08663e2e4c51ed03aaeb547e2e0b83fd37b73"; }
    if(Height < 0) { return "0x000007d69ba0f79b4823effb06b08663e2e4c51ed03aaeb547e2e0b83fd37b73"; }
    int desiredheight;
...
std::string getBlockMerkle(int Height)
{
    ...
    CBlock block;
    CBlockIndex* pblockindex = mapBlockIndex[hash];
    return pblockindex->hashMerkleRoot.ToString().substr(0,64).c_str();
}
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " PAK");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " PAK");
