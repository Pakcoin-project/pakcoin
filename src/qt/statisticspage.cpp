...
uint64_t destroyedStakec =  65217844.265830 * COIN;  //https://www.richlist.eu/pakcoin/stats/destroyed
...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " PAK" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " PAK" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " PAK");
    }
    
    ui->rewardBox->setText(QString::number(nMint, 'f', 6) + " PAK");
    //ui->circBox->setText(QLocale(QLocale::English).toString(aliveVolume) + " PAK"); 
